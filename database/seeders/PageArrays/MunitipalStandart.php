<?php
 $data_munitipal = [
    ...
    [
        ...
        'name_en' => 'Gorshechensky district',
        'type' => 'Районы',
        'title' => 'Горшеченский район Курской области',
        'title_en' => 'Gorshechensky district of the Kursk region',
        'glava' => 'Амерев Андрей Михайлович',
        'glava_en' => 'Amerev Andrey Mikhailovich',
        'address' => '306800, Курская обл., Горшеченский р-н, р.п.Горшечное, улица Кирова д.28',
        'address_en' => '306800, Kursk region, Gorshechensky district, Gorshechnoye settlement, Kirova Street, 28',
        ...
        'description' => 'ENG_gorshechensky.html',
        'passport_files' => [
            [
                'title' => "Паспорт МО-1",
                'title_en' => "MO-1 passport",
                'description' => "",
                'description_en' => "",
                'file' => "1-1-4.png"
            ],
