...
@section('main')
    ...
    <div class="inner">
        ...
        <h2>Информационные ресурсы поддержки экспортеров</h2>
        <div class="irtse-item-box">
            <div class="irtse-item">
                <img src="{{asset('img/tmp/irtse-item-1.webp')}}" alt="" class="irtse-item__img">
                <ul>
                    <li>123610, Россия, г. Москва Краснопресненская набережная, дом 12, подъезд 9</li>
                    <li>+7 (495) 937-4747, 8-800-550-01-88</li>
                    <li><a href="info@exportcenter.ru">info@exportcenter.ru</a></li>
                </ul>
            </div>
            <div class="irtse-item">
